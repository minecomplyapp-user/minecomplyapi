          ...
          implementationOfEnvironmentalImpactControlStrategies: [
            {
              ...
              commitments: [
                ...
                {
                  plannedMeasure:
                    '9. Regular check-up mufflers of all equipment.',
                  actualObservation:
                    'Hauling trucks are properly maintained by concerned service contractors.',
                  isEffective: true,
                  recommendations: '',
            ...
            },
            {
              ...
              commitments: [
                {
                  plannedMeasure:
                    '1. Use off-site disposal of hazardous wastes.',
                  actualObservation:
                ...
                },
                {
                  ...
                  actualObservation:
                    'Saw dust are being used as oil absorbents.',
                  isEffective: true,
                  recommendations: '',
                },
                {
                ...
                {
                  plannedMeasure:
                    '11. Use dredge spoil for reclamation purposes.',
